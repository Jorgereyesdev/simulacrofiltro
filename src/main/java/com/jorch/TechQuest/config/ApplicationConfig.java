...
import com.jorch.TechQuest.application.services.CustomUserDetailsService;
...
public class ApplicationConfig {
    ...
    public AuthenticationProvider authenticationProvider() {
        ...
        authenticationProvider.setUserDetailsService(customUserDetailsService); // Usar CustomUserDetailsService
